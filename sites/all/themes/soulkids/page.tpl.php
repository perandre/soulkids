...
<body class="<?php print $body_classes; ?>">
  ...
  <div id="page" class="container-16 clear-block">
    ...
    <div id="header" class="clear-block">
      <h1 id="logo" class="grid-3 clear-block"><a href="<?php print $base_path; ?>">Soulkids barnekor i Fredrikstad</a></h1>
    ...
    <div id="main" class="column <?php print ns('grid-16', $left, 4, $right, 4, $right2, 4) . ' ' . ns('push-4', !$left, 4); ?>">
      ...
      <div id="content" class="region clear-block">
        <?php print $content; ?>
      </div>
  ...
  <?php if ($right2): ?>
    <div id="sidebar-right2" class="column sidebar region grid-4">
      <div id="activity2">
        <?php print $right2; ?>
      </div>
    </div>
